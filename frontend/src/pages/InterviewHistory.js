    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8" data-testid="interview-history-page">
      <div className="flex items-center justify-between">
        ...
        <Select value={filter} onValueChange={setFilter}>
          <SelectTrigger className="w-[150px]" data-testid="history-filter">
        ...
        <Card className="border" data-testid="empty-history">
          <CardContent className="py-16 flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <p className="font-semibold mb-1">No interviews found</p>
              <p className="text-sm text-muted-foreground">Start your first interview to see it here</p>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className={`w-10 h-10 rounded-md flex items-center justify-center ${
                      interview.type === 'role' ? 'bg-primary/10' : 'bg-emerald-500/10'
                    }`}>
                      {interview.type === 'role' ? (
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="font-semibold text-sm">
                          {interview.type === 'role' ? interview.role : 'Resume-Based Interview'}
                        </h3>
                        <Badge
                      ...
                      <div className="flex items-center gap-4 mt-1 text-xs text-muted-foreground">
                        <span className="flex items-center gap-1">
                          <Calendar className="w-3 h-3" /> {formatDate(interview.created_at)}
                        </span>
